...
public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
        ...
        .authorizeHttpRequests(authz -> authz
            ...
            .requestMatchers(new AntPathRequestMatcher("/api/auth/google-login", "POST")).authenticated()
            .requestMatchers(new AntPathRequestMatcher("/api/auth/link-google", "POST")).authenticated()
            .requestMatchers(new AntPathRequestMatcher("/getUsernameByEmail", "GET")).authenticated()
